...
public class CreativeToolsFeatures {
    ...
    /**
     * Activates the sketch functionality upon clicking the "Draw" button.
     * Sets up the necessary event handlers for drawing on the canvas within the selected tab.
     *
     * @param tabPane The TabPane containing tabs, where drawing will occur on the selected tab.
     * @param colorPicker The ColorPicker used to select the drawing color.
     * @param lineThickness The Slider used to set the thickness of the drawing lines.
     * @param undostack The Stack used to manage the undo functionality for the drawing.
     */
