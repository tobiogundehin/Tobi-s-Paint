...
public class HelpInfo {
    ...
    public void shortCutDisp(){
        Stage helpWindow = new Stage();
        BorderPane shortCutList = new BorderPane();
        String shortCutText =
                "Shortcuts:\n" +
                "Open: Ctrl + O\n " +
                "New Tab: Ctrl + T\n " +
        ...
        shortCutList.setCenter(shortCutLabel);
        Scene helpScene = new Scene(shortCutList, 600, 800);
        helpWindow.setTitle("Shortcuts");
        helpWindow.setScene(helpScene);
        helpWindow.show();
    }
}
