...
//        polygonSidesSlider.setShowTickMarks(true);
        ...
        Label javaPun = new Label("Why do Java developers wear glasses, because they can't see sharp (C#) ");
        ...
        //Open default scene
        Scene defaultScene = new Scene(borderPane, 1200, 800);
